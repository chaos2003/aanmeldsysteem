...
$meldingCell[1] = '<td style="background-color:green;text-align: center;">Borrel</td>';
$meldingCell[2] = '<td style="background-color:gray;text-align: center;">Geen turf</td>';
$meldingCell[3] = '<td style="background-color:yellow;color:black;text-align: center;">Alleen eten</td>';
$meldingCell[4] = '<td style="background-color:red;text-align: center;">Afwezig</td>';
/*
$meldingCell[0] = '<td style="background-color:black;text-align: center;"></td>';
